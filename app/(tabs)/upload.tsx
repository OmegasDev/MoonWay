...
export default function UploadTabScreen() {
  ...
  const [chatMessages, setChatMessages] = useState([
    {
      id: 1,
      type: 'ai',
      text: "Hi! 👋 Ready for another profile analysis? Let's optimize your social media presence!",
      timestamp: new Date()
    }
  ]);
  ...
  const handleGoalsSubmit = () => {
    ...
    simulateTyping(() => {
      ...
      setTimeout(() => {
        Alert.alert('Analysis Complete!', 'Your profile analysis is ready. Check your dashboard for insights!');
        ...
        setChatMessages([{
          id: Date.now(),
          type: 'ai',
          text: "Analysis complete! 🎉 Ready for another profile optimization?",
          timestamp: new Date()
        }]);
      }, 2000);
    }, 2000);
